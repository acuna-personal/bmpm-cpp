...
/* ORIG: abstract  */ class BMPM
{
    ...
    public: static const std::string MATCHING_APPROXIMATE;
    public: static const std::string MATCHING_EXACT;
    public: static const std::string MATCHING_HEBREW;
    ...
    private: php_type _hebrew;
    private: php_type _hebrewCommon;
    ...
    public: php_type getHebrew();
    public: void setHebrew(php_type exact);
    public: php_type getHebrewCommon();
    public: void setHebrewCommon(php_type hebrewCommon);
