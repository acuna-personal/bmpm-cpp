...
#ifndef APPROXANY_CPP
#define APPROXANY_CPP
...
approxAny = {
    ...
    {"b", "", "", "(b|v[" + spanish + "])"},
    {"J", "", "", "z"},
    // Argentina Spanish: "ll" = /Z/, but approximately /Z/ = /z/
    // VOWELS
    ...
    // Wineberg (vineberg/vajneberg) --> vajnberg
    {"E", "a[^aeiouAEIOU]", "", "(i|Y[" + german + "]|[" + english + "])"},
    //  Shaneberg (shaneberg/shejneberg) --> shejnberg
    {"e", "", "[fklmnprstv]$", "i"},
    {"e", "", "ts$", "i"},
    {"e", "", "$", "i"},
    {"e", "[DaoiuAOIUQY]", "", "i"},
