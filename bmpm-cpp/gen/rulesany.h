...
rulesAny = {
    ...
    // ts It, s/S/Z Port, s in Sp, z Fr
    {"z", "", "[bdgv]", "(z|dz[" + italian + "]|Z[" + portuguese + "])"},
    // dz It, Z/z Port, z Sp & Fr
    {"z", "", "[ptckf]", "(s|ts[" + italian + "]|S[" + portuguese + "])"},
    // ts It, s/S/z Port, z/s Sp
    // VOWELS
    {"aue", "", "", "aue"},
    {"oue", "", "", "(oue|ve[" + french + "])"},
    {"eau", "", "", "o"},
    ...
    //array("ļ","","","l"), // latvian Beider_2017
    {"ķ", "", "", "(k|t[" + latvian + "]|tj[" + latvian + "])"},
    // latvian
    ...
    // S/ks Port & Sp, gz Sp, It only ks
    {"y", "", "", "i"},
    {"z", "", "", "(z|ts[" + german + "]|dz[" + italian + "]|ts[" + italian + "]|s[" + spanish + "])"},
    // ts/dz It, z Port & Fr, z/s Sp
    {"rulesany"},
};
